    ...
    <div className="flex flex-col lg:flex-row items-center justify-between h-[500px] pt-8 px-4 sm:px-6 lg:px-8 gap-8">
      ...
      <div className="lg:w-1/2 w-full max-w-4xl mx-auto lg:mx-0 space-y-6 text-center lg:text-left">
        ...
        >
          ...
          <div className="relative bg-white dark:bg-gray-900 rounded-full py-2 px-4 text-center">
            <p className="text-xs font-medium">Streamlined education management <a href="https://crack.diy" className="hover:opacity-80 underline">crack.diy</a> 🎓</p>
          </div>
        </motion.div>
        ...
        >
          Simplify course management, track student progress, and enhance learning outcomes with our comprehensive teacher dashboard.
        </motion.p>
      ...
      >
        ...
        >
          ...
          <p className="text-sm font-medium">"Transformed how I manage my classroom."</p>
          <p className="text-xs mt-1 text-gray-600 dark:text-gray-400">- Sarah J., High School Teacher</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm font-medium">"Student engagement has improved dramatically."</p>
          <p className="text-xs mt-1 text-gray-600 dark:text-gray-400">- Michael T., Department Head</p>
        </motion.div>
      </motion.div>
    </div>
  );
